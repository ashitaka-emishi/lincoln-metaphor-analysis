...
short_title: "Prelim Emancipation"
date: "1862-09-22"
date_precision: "exact"
register: "legal_document"
authorship: "lincoln_sole"
authorship_confidence: 0.90
authorship_notes: "Autograph in Lincoln's hand except as noted: Seward inserted 'with their consent' and 'with the previously obtained consent of the Governments existing there'; clerk wrote the formal beginning and ending. Quoted acts of Congress are pasted clippings from official printings, not in Lincoln's hand."
source_text: "Collected Works vol.5 pp.433-436"
...
[5]   At this point Lincoln deleted and revised his original phrasing.
...
[8]   ``In due time'' is inserted in handwriting not Lincoln's, to replace ``at the next session of Congress.''
