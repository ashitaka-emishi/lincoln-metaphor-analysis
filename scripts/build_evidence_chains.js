...
function makeRecord(inst, sentence, paragraph, section, docMeta) {
  ...
  return {
    ...
    document: {
      ...
      date: inst.document_date || docMeta.date || null,
      period: docMeta.period || null,
      genre: docMeta.genre || null,
      register: inst.document_register || docMeta.register || null,
      authorship: docMeta.authorship || null,
      authorship_confidence: inst.authorship_confidence ?? docMeta.authorship_confidence ?? null,
