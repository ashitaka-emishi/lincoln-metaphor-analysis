...
The study is designed but not executed. No validated Stage 4H human coder submissions are present, so no human-human metric is reported.

## Human Coders

Primary human coder submissions available: **0**. The complete metric gate requires two primary coders, `human_coder_a` and `human_coder_b`.
...
Packet: `stage4h_dac4a065fdfff159`. Packet units: **106**; identification units: **55**; field-agreement units: **51**.
...
No identification reliability metric is available before two validated primary submissions exist.

## Lexical Boundary Agreement

No lexical-boundary agreement metric is available before two validated primary submissions exist.

## CMT Mapping Agreement

No CMT mapping agreement metrics are available.

## Koenigsberg Interpretive Agreement

No Koenigsberg interpretive agreement metrics are available.

## Absence and Agency Agreement

No absence or agency agreement metrics are available.

## Disease and Purification Checks

No disease or purification agreement metric is available before two validated primary submissions exist.

## Confidence and Ambiguity

No confidence or ambiguity agreement metrics are available.

## Human-vs-Reference Comparison

No human-vs-Stage 4A comparison is available before validated human submissions exist.
...
Stage 4J status: **no decisions**. Valid adjudication decisions: **0**. Stage 4A correction candidates exported for review: **0**.
