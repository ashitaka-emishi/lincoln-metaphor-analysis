...
> corpus construction → metaphor identification → conceptual mapping → discourse analysis → ideological interpretation → publication-ready synthesis
...
> scholarly claim → metaphor cluster → conceptual mapping → metaphor-related lexical units → sentence IDs → document metadata → source text

This pipeline keeps interpretive richness while making the research process auditable.
...
| Koenigsbergian ideological-fantasy analysis | Interprets sacrifice, sacred collective objects, national fantasy, violence, guilt, redemption, and reconciliation |
...
| 13 | Koenigsbergian ideological-fantasy synthesis | Interpretive synthesis |
| 14 | Comparative analysis | Structured comparison protocol |
| 15 | Validation, audit, and publication package | Peer-review-ready method appendix |
...
The upgraded pipeline should be evaluated by whether each methodological addition strengthens the evidence chain for the primary research question:
...
Secondary questions about metaphor clusters, obligatory framing, systematic absence, and purification-based political rhetoric remain in scope, but they function as supporting questions rather than coequal project centers.
...
# Stage 13: Koenigsbergian Ideological-Fantasy Synthesis

## Objective

Interpret how Lincoln’s metaphor system organizes sacrifice, sacred collective objects, national fantasy, guilt, death, redemption, and reconciliation.

## Purpose

This stage should come after MIPVU, CMT, corpus analysis, rhetorical analysis, and absence analysis. It is the interpretive synthesis, not the identification method.
...
| Enemy figure | Rebel, slave power, secessionist | Parasite, contaminant, racial enemy |
...
# Stage 15: Validation, Audit, and Publication Package
...
| `koenigsbergian-synthesis.md` | Presents final interpretive argument |
...
| Candidate metaphor detection | Suggest possible metaphor-related units | Apply MIPVU manually or verify rigorously |
...
| Cluster discovery | Suggest patterns | Validate against annotations |
| Corpus summaries | Assist synthesis | Verify against evidence |
...
9. Rival readings and negative cases
10. Audit trail from claims to source text
11. AI-use statement
